...
/**
 ...
 @param UrlArr 头视图轮播图的url
 */


-(void)setGoodsDetailLayout:(UIViewController*)viewController WebViewURL:(NSString*)webViewURL IsConverAnimation:(BOOL)isConverAnimation bottomHeighr:(CGFloat)bottomHeight :(NSArray* )UrlArr cellModel:(ProductDetailModel*)model;//滚动监听Block:为YES是滚动到了商品详情 NO滚动到图文详情
